...
const Player: React.FC<PlayerProps> = ({ song, isPlaying, setIsPlaying, onNext, onPrev, isLiked, onToggleLike }) => {
    ...
    <div className="fixed bottom-0 left-0 right-0 h-24 bg-black border-t border-white/5 px-4 flex items-center justify-between z-50">
      ...
      <div className="flex items-center gap-4 w-[30%]">
        ...
        <button
          ...
          className={`ml-2 transition active:scale-90 ${isLiked ? 'text-pink-500' : 'text-gray-400 hover:text-pink-400'}`}
