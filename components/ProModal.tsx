    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-md p-4 animate-fadeIn">
      <div className="bg-gradient-to-b from-[#242424] to-black w-full max-w-lg rounded-3xl overflow-hidden shadow-2xl relative border border-white/10">
        ...
        <div className="p-10 text-center">
          <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-6 shadow-[0_0_30px_rgba(59,130,246,0.4)]">
          ...
          <button
            ...
            className="w-full bg-blue-500 hover:bg-blue-400 text-black font-black text-lg py-4 rounded-full transition transform active:scale-95 shadow-xl"
          >
            GET PREMIUM
          </button>
        </div>
